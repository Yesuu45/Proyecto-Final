...
public class Empleado extends Persona {
    ...
    public void registrarVehiculo(Consecionario concesionario, Vehiculo vehiculo) {
        concesionario.agregarVehiculo(vehiculo);
        System.out.println("Vehículo registrado exitosamente por el empleado: " + getNombre());
    }

    public void registrarCliente(Consecionario concesionario, Cliente cliente) {
        concesionario.agregarCliente(cliente);
        System.out.println("Cliente registrado exitosamente: " + cliente.getNombre());
    }

    public void alquilarVehiculo(Consecionario concesionario, Cliente cliente, Vehiculo vehiculo, String fechaInicio, String fechaFin) {
    ...
    public void venderVehiculo(Consecionario concesionario, Cliente cliente, Vehiculo vehiculo) {
        if (concesionario.getVehiculosDisponibles().contains(vehiculo)) {
            concesionario.removerVehiculo(vehiculo);
    ...
    public void comprarVehiculo(Consecionario concesionario, Cliente cliente, Vehiculo vehiculo) {
